...
@Component({
  selector: 'static-gas-production-summary',
  templateUrl: './static-gasProductionSummary.component.html',
  styleUrls: ['./static-gasProductionSummary.component.scss'],
  encapsulation: ViewEncapsulation.None,
  standalone: true,
  imports: [RouterLink, HighchartsChartModule, CommonModule, LottieComponent],
})
export class StaticGasProductionSummaryComponent {
  @Input() hideAreaChart: boolean = false;
